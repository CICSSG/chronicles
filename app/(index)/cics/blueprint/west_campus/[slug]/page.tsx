...
export default function Page() {
  ...
  useEffect(() => {
    setDocument(westDocuments?.find((doc) => String(doc.id) === slug) || null);
  }, [eastDocuments]);
      ...
      <div className="flex w-full flex-col gap-8 xl:rounded-xl xl:bg-white/80 xl:p-8">
        <div className="flex flex-col gap-4">
          ...
          <div className="block">
            {isLoaded ? (
              <>
                ...
                {document && document.description.length > 2 ? (
                  <pre className="font-black/80 my-5 text-justify text-lg font-normal text-wrap">
          ...
          <div className="flex flex-row items-center gap-4">
            ...
            {document && document.location.length > 2 ? (
              <Link
              ...
              <span className="text-md/0 rounded-full bg-black/10 px-4 py-1 font-semibold">
