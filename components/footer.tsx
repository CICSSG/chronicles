...
const Footer = () => {
  ...
  return (
    <div
      className={`flex w-full flex-col md:flex-row justify-between gap-12 overflow-hidden rounded-2xl border border-neutral-400 bg-white bg-linear-to-br from-neutral-100 via-neutral-100 via-70% to-blue-200 p-8 py-12 text-2xl ${pathname == "/" ? "m-auto max-w-full xl:max-w-10/12" : null}`}
    >
