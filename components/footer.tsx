...
const Footer = () => {
  ...
  return (
    <div
      className={`flex w-full flex-col justify-between gap-12 overflow-hidden rounded-2xl border border-neutral-400 bg-white bg-linear-to-br from-neutral-100 via-neutral-100 via-70% to-black/25 p-8 py-12 text-2xl md:flex-row m-auto max-w-full 2xl:max-w-10/12`}
    >
