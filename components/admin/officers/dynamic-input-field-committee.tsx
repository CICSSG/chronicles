...
export default function DynamicInputFieldsCommittee({data} : {data?: any}) {
  ...
  return (
    <div className="container flex flex-col gap-2">
      ...
      <input name="committee_list" type="text" value={JSON.stringify(inputs)} className="invisible sr-only" readOnly />
    </div>
  );
}
