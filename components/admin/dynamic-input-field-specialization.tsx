...
export default function DynamicInputFieldsSpecialization({data} : {data?: any}) {
  ...
  return (
    <div className="container flex flex-col gap-2">
      ...
      <input name="specialization_data" type="text" value={JSON.stringify(inputs)} className="invisible sr-only" readOnly />
    </div>
  );
}
