  ...
  return (
    <div className="flex flex-col">
      <div className="flex items-center">
        <ul className="group transition-[width, padding] flex h-screen w-15 flex-col items-center gap-3 overflow-hidden bg-neutral-800 bg-gradient-to-b from-neutral-700 to-neutral-800 p-2 text-white duration-500 hover:w-60 hover:items-stretch hover:gap-5 hover:p-5">
            ...
            <>
              {/* <li>
                <Link
                  ...
                  className="flex w-fit flex-nowrap items-center gap-2"
                >
                  <PrinterIcon className="w-fit text-3xl" />
                  <span className="hidden text-nowrap group-hover:block">
                    FetchDesk
                  </span>
                </Link>
              ...
              <li>
                <Link
                  ...
                  className="flex w-fit flex-nowrap items-center gap-2"
                >
                  <CalendarCheckIcon className="w-fit text-3xl" />
                  <span className="hidden text-nowrap group-hover:block">
                    Attendance
                  </span>
                </Link>
