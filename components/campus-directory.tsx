...
export default function CampusDirectory({
  ...
  return (
    <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
      <ul className="list bg-base-100 rounded-box shadow-md h-fit">
        <li className="p-4 pb-2 text-xs tracking-wide opacity-80">
          East Campus
        </li>

        {isLoaded ? (
          east_campus?.map((data, i) => (
            <li className="list-row" key={i}>
              <div className="my-auto text-4xl font-light tabular-nums opacity-30">
                {String(data.number).padStart(2, "0")}
              </div>
              <div className="my-auto">{data.name}</div>
              <a
                className="btn btn-square btn-ghost my-auto"
                href={"/cics/blueprint/east_campus/" + data.id}
              >
                <svg
          ...
          <>
            <li className="list-row">
              <div className="skeleton aspect-square w-10"></div>
              <div className="skeleton my-auto h-4"></div>
              <div className="btn btn-square btn-ghost my-auto">
                <svg
                  className="size-[1.2em]"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
        ...
        {isLoaded ? (
          west_campus?.map((data, i) => (
            <li className="list-row" key={i}>
              ...
              <a
                className="btn btn-square btn-ghost my-auto"
                href={"/cics/blueprint/west_campus/" + data.id}
              >
                <svg
                  className="size-[1.2em]"
                  xmlns="http://www.w3.org/2000/svg"
